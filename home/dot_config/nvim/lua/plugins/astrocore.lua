  ...
  opts = {
    ...
    options = {
      opt = { -- vim.opt.<key>
        ...
        breakindentopt = "shift:2,min:40,sbr", -- ident by an additional 2 characters on wrapped lines, when line >= 40 characters, put 'showbreak' at start of line
        showbreak = ">>", -- append '>>' to indent
        linebreak = true, -- wrap long lines at a character in 'breakat' rather	than at the last character that fits on the screen.
        fillchars = "eob:~", -- the tilde (~) at the left of on empty lines
        --<<CUSTOM>>}
